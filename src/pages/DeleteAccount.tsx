...
const DeleteAccount: FC = () => {
  return <section className={styles.container}>
    ...
    <p>
      To delete your account and associated data from Sharlushka
      Dice Game, follow these steps:
    </p>

    <p>
      <strong>1. Initiate Deletion:</strong> Log in to your account,
      navigate to the profile page and click the
      &apos;Delete Account&apos; link.
    </p>

    <p>
      <strong>2. Confirmation:</strong> Confirm your decision to delete the account.
    ...
    <p>
      ...
      <ul>
        ...
        <li>
        <strong>Game Results:</strong> All associated game results will be removed
          from our system.
        </li>
        <li>
        <strong>Access Tokens:</strong> Any access tokens related to your account
          will be invalidated.
        </li>
        <li>
